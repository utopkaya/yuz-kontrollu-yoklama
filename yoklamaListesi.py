...
class Ui_Dialog_YoklamaListesi(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Yoklamaya Kayıtlı Listesi")
        ...
        try:
            ...
            cursor.execute("SELECT * FROM yoklama")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Yoklamaya Kayıtlı Öğrenci Listesi"))
